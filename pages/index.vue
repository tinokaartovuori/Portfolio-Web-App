  ...
  <ScrollContainer>
    <div class="home-intro h-screen w-full">
      ...
      >
        <div class="-mt-[5vh]">
          <p
            class="xxs:text-xl text-onyx dark:bg-onyx/50 bg-slate-400/50 text-lg dark:text-white sm:text-2xl md:text-4xl lg:text-5xl"
          >
...
.index-intro_wrapper {
  position: absolute;
  left: calc(3.125px + 12.5%);
  right: calc(3.125px + 12.5%);
  width: calc(-6.25px + 75%);
}
</style>
